...
import static com.example.android.viewpagerinrecyvlerviewdemo.R.styleable.RecyclerView;
...
//        songList = getSongList();
    ...
    private List<Model> loadModels() {
        ...
        for(int i = 1; i <= LIST_SIZE; i++){
            ...
            model.setDescription("This is the description for the model #" + i);
            model.setImages(new int[]{R.drawable.bigbang, R.drawable.game_of_thrones, R.drawable.hannibal, R.drawable.house});
            models.add(model);
        }
        return models;
    }
